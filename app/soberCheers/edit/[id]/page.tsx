...
const filledInput = (v: string | number) => v !== '' && v !== 0 ? `${base} border border-[oklch(89.7%_0.196_126.665)] bg-[oklch(97%_0.196_126.665)]` : inputCls;
const filledSelect = (v: string | number) => v !== '' && v !== 0 ? `${base} border border-[oklch(89.7%_0.196_126.665)] bg-[oklch(97%_0.196_126.665)] cursor-pointer` : selectCls;
                  ...
                  {['ชาย', 'หญิง', 'LGBTQ'].map(g => (
                    <button key={g} type="button" onClick={() => set('gender', g)}
                      className={`flex-1 py-2 text-sm rounded-lg border transition-colors ${
                        form.gender === g
                          ? 'bg-[oklch(80%_0.196_126.665)] border-[oklch(80%_0.196_126.665)] text-white font-medium'
          ...
          <div className="p-6">
            ...
            <div className="flex gap-3">
              ...
              <button type="submit" disabled={submitting}
                className="flex-1 py-3 bg-[oklch(80%_0.196_126.665)] hover:bg-[oklch(68%_0.196_126.665)] text-white text-sm font-semibold rounded-lg transition-colors disabled:opacity-50 flex items-center justify-center gap-2">
                {submitting ? (
